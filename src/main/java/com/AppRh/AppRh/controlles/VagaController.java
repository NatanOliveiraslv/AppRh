package com.AppRh.AppRh.controlles;
...
public class VagaController {
    ...
    public String detalheVagaPost(@PathVariable("codigo") long codigo, @Valid Candidato candidato,
    ...
    //Metodo que atualizam vaga
    //Formulário ediçao de vaga
